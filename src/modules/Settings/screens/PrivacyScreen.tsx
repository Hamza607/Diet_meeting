...
const PrivacyScreen: React.FC = () => {
  return (
    <Box className="w-full max-w-[1055px]">
      <Typography variant="h1" className="lg:text-[2em] sm:text-2xl text-xl">
        Privacy Policy
      </Typography>
      <Typography className="text-sm font-inter-semibold font-semibold text-secondary-thin mt-5 mb-8">
        Last updated June 28, 2019
      </Typography>
      <Typography className="lg:text-xl sm:text-base text-sm text-secondary-light">
