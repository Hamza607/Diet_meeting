...
import type { IInfoScreen3 } from "@types";
import { IMG } from "@constants";
import { AppButton } from "@components";

const InfoScreen3: React.FC<IInfoScreen3> = ({ handleNextButton }) => {
  return (
    <Box className="w-full h-auto min-h-[calc(100vh-165px)] max-w-[1300px] mx-auto xl:pl-[5em] px-[1em] lg:pt-[8.5em] pt-[5em] pb-[3em]">
      ...
      >
        <Col lg={12} xs={24}>
          ...
          >
            There’s no one perfect diet—only what works for your body and
            lifestyle.
          </Typography>
          <Typography className="sm:text-xl text-base lg:text-left text-center font-poppins-bold font-bold text-secondary-light sm:my-[3em] my-[2em]">
            We’re here to help you explore and personalize what works best for
            you.
          </Typography>
          <AppButton onClick={handleNextButton}>That makes sense</AppButton>
        </Col>
        <Col
          lg={12}
          xs={24}
        ...
        >
          <Box
            component="img"
            src={IMG.ONBOARDING.ONBOARDING_6}
            alt=""
