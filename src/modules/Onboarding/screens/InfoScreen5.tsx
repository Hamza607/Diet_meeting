...
import type { IInfoScreen5 } from "@types";
import { IMG } from "@constants";
import { AppButton } from "@components";

const InfoScreen5: React.FC<IInfoScreen5> = ({ handleNextButton }) => {
  return (
    <Box className="w-full h-auto min-h-[calc(100vh-165px)] max-w-[1300px] mx-auto xl:pl-[5em] px-[1em] lg:pt-[8.5em] pt-[5em] pb-[3em]">
      ...
      >
        <Col lg={12} xs={24}>
          ...
          >
            You’re more likely to reach your goals when you celebrate small
            wins.
          </Typography>
          <Typography className="sm:text-xl text-base lg:text-left text-center font-poppins-bold font-bold text-secondary-light sm:my-[3em] my-[2em]">
            Logging your progress and sharing milestones helps you stay
            motivated.
          </Typography>
          <AppButton onClick={handleNextButton}>Love that</AppButton>
        </Col>
        <Col
          lg={12}
          xs={24}
        ...
        >
          <Box
            component="img"
            src={IMG.ONBOARDING.ONBOARDING_10}
            alt=""
