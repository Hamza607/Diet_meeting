...
import type { IInfoScreen4 } from "@types";
import { IMG } from "@constants";
import { AppButton } from "@components";

const InfoScreen4: React.FC<IInfoScreen4> = ({ handleNextButton }) => {
  return (
    <Box className="w-full h-auto min-h-[calc(100vh-165px)] max-w-[1300px] mx-auto xl:pl-[5em] px-[1em] lg:pt-[8.5em] pt-[5em] pb-[3em]">
      ...
      >
        <Col lg={12} xs={24}>
          ...
          >
            Most people regain weight because they didn’t change their
            environment.
          </Typography>
          <Typography className="sm:text-xl text-base lg:text-left text-center font-poppins-bold font-bold text-secondary-light sm:my-[3em] my-[2em]">
            That’s why we help you build a lifestyle, not just a short-term
            plan.
          </Typography>
          <AppButton onClick={handleNextButton}>On to the next</AppButton>
        </Col>
        <Col
          lg={12}
          xs={24}
        ...
        >
          <Box
            component="img"
            src={IMG.ONBOARDING.ONBOARDING_9}
            alt=""
