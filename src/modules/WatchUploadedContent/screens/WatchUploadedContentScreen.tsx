...
import { UploadedContentVideo } from "@watchUploadedContentComponents";
import { useAppContext } from "@context";

const WatchUploadedContentScreen = () => {
  ...
  const groupButtons = [
    {
      classname: "md:!w-[110px] !w-[52px] h-[35px]",
      label: "100",
      icon: ICON.CONTENTHUB.THUMBLIKE,
      onClickHandle: () => console.log("clicked 100"),
    },
    {
      classname: "!w-[52px]  h-[35px]",
      label: "",
      icon: ICON.CONTENTHUB.THUMBUNLIKE,
...
export default WatchUploadedContentScreen;
